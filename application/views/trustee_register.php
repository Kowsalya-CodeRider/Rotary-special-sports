...
<div class="wrapper">
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-male"></i> Founder:</a></li>
        <li class="active">Paul P. Harris</li>
      </ol>
    </section>
      <div class="row">
        <div class="col-md-12">
          <div class="box box-warning">
            ...
            <br><br>
            <div class="box-body">
            <form class="form-horizontal" action="<?php echo SITE_URL;?>Rotary/trustee_insert" method="post">
            ...
            <td><center><strong>Contact Number</strong></center><br><div class="input-group"><div class="input-group-addon">
                  ...
                  </div><input type="text" class="form-control name_list" name="name1[]" id="phno" maxlength="10" placeholder="Enter Trustee contact No" required></div> </td>
