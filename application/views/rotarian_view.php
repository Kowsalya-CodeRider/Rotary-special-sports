          ...
          <div class="box box-danger">
            ...
            <form class="form-horizontal" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" class="form-control" value="<?php echo $plist->phno;?>" readonly>
            </div>
              </div>
              <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                <input type="email" class="form-control" value="<?php echo $plist->email;?>" readonly>
            </div>
              </div>
              <div class="form-group">
                <label class="col-md-3 control-label">Password:</label>
                <div class="col-sm-7">
                <input type="text" class="form-control" value="<?php echo $plist->password;?>" readonly>
            </div>
              </div>       
              <div class="form-group">
                <label class="col-md-3 control-label">Address:</label>
                <div class="col-sm-7">
                  <input type="text" class="form-control" rows="3" value="<?php echo $plist->address;?>" readonly>
            </div>
              </div>
              <div class="form-group">
                <label class="col-md-3 control-label">Rotractors:</label>
                <div class="col-sm-7">
                 <?php if(count($rlist) == 0)
                 {
                  ?>
                  <input type="text" class="form-control" rows="3" value="<?php echo "Not assigned"?>" readonly>
                  <?php
                    }
                    else
                    {
                    ?>
                    <textarea type="text" class="form-control" readonly><?php foreach($rlist as $row)
                    {
                      echo $row->name."\n"; 
                    }
