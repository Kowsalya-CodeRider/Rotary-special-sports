...
class Template
{
	...
	$data['_side_bar']=$this->_ci->load->view('template/side_bar',$data,true);
	$data['_navigation_bar']=$this->_ci->load->view('template/navigation_bar',$data,true);
	$data['_header_file']=$this->_ci->load->view('template/i_header_file',$data,true);
